...
<body>
	...
	<content>
		<main>
			<h2>H2 header</h2>
			<p>Tekstiä tekstiä whoopwhoop </p>
		...
		<side>
			<twitter>
				<a class="twitter-timeline" width="250" height="350" data-dnt="true" href="https://twitter.com/AnimeconFI" data-widget-id="558954967277768704">Tweets by @AnimeconFI</a>
			...
			<sponsors>
				 <h1>Sponsorit</h1>
				<img src="/img/sponsorit/sponssi.jpg"></img>
			</sponsors>
		</side>
