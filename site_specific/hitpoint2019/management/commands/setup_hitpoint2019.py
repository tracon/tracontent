...
class Setup(object):
    ...
    def setup(self):
        print('NOTE: Setting up Tracon Hitpoint 2019 site at {domain}'.format(domain=self.domain))
        self.setup_site()
        self.setup_content()
        self.setup_ads()
        self.setup_blog()
    ...
    def setup_content(self):
        ...
        self.site_settings, unused = SiteSettings.objects.get_or_create(
            site=self.site,
            defaults=dict(
                base_template='hitpoint2019_base.jade',
                page_template='hitpoint2019_page.jade',
                blog_index_template='hitpoint2019_blog_index.jade',
                blog_post_template='hitpoint2019_blog_post.jade',
                context_processor_code='site_specific.hitpoint2019.context_processors:hitpoint2019_context',
            )
        )
        ...
        for field_name in [
            ...
            if 'hitpoint2015' in value:
                value = value.replace('hitpoint2015', 'hitpoint2019')
        ...
        if not fi_front_page.override_page_template:
            fi_front_page.override_page_template = 'hitpoint2019_front_page.jade'
        ...
        #         public_from=t,
        #         visible_from=t,
        #         page_controller_code='site_specific.hitpoint2019.views:programme_page_controller',
        #         override_page_template='hitpoint2019_programme_page.jade',
        #         order=0,
        #     )
        # )
        #
        # programme_schedule_page.page_controller_code = 'site_specific.hitpoint2019.views:programme_page_controller'
        # programme_schedule_page.override_page_template = 'hitpoint2019_programme_page.jade'
