    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('public_from', models.DateTimeField(help_text='Sivu on t\xe4st\xe4 hetkest\xe4 alkaen my\xf6s sis\xe4\xe4nkirjautumattomien k\xe4ytt\xe4jien luettavissa, jos n\xe4m\xe4 tiet\xe4v\xe4t osoitteen.', null=True, verbose_name='Julkaisuaika', blank=True)),
                ('visible_from', models.DateTimeField(help_text='Sivu on t\xe4st\xe4 hetkest\xe4 alkaen n\xe4kyviss\xe4 valikossa tai listauksessa.', null=True, verbose_name='N\xe4kyviss\xe4 alkaen', blank=True)),
                ('title', models.CharField(help_text='Otsikko n\xe4ytet\xe4\xe4n automaattisesti sivun yl\xe4laidassa. \xc4l\xe4 lis\xe4\xe4 erillist\xe4 p\xe4\xe4otsikkoa sivun tekstiin.', max_length=1023, verbose_name='Otsikko')),
                ('body', models.TextField(verbose_name='Leip\xe4teksti')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('public_from', models.DateTimeField(help_text='Sivu on t\xe4st\xe4 hetkest\xe4 alkaen my\xf6s sis\xe4\xe4nkirjautumattomien k\xe4ytt\xe4jien luettavissa, jos n\xe4m\xe4 tiet\xe4v\xe4t osoitteen.', null=True, verbose_name='Julkaisuaika', blank=True)),
                ('visible_from', models.DateTimeField(help_text='Sivu on t\xe4st\xe4 hetkest\xe4 alkaen n\xe4kyviss\xe4 valikossa tai listauksessa.', null=True, verbose_name='N\xe4kyviss\xe4 alkaen', blank=True)),
                ('title', models.CharField(help_text='Otsikko n\xe4ytet\xe4\xe4n automaattisesti sivun yl\xe4laidassa. \xc4l\xe4 lis\xe4\xe4 erillist\xe4 p\xe4\xe4otsikkoa sivun tekstiin.', max_length=1023, verbose_name='Otsikko', blank=True)),
                ('body', models.TextField(verbose_name='Leip\xe4teksti')),
